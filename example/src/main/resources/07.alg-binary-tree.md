...
你有一个保存员工信息的数据结构，它包含了员工唯一的 id、重要度、直系下属的 id 。
...
![示例1](./img/07.binary-tree/q690_example01.png)
...
![示例2](./img/07.binary-tree/q690_example02.png)
